...
-   **Planning:**
    ...
    -   Merge the 'Myers-Briggs' dataframe with the 'Characters' dataframe using the common column 'char_id' to get the 'Myers-Briggs' type and average match percentage for each character.
